...
rules = {'1110':'f,s,st = indat[itt+1],indat[itt+2],index+3','1100':'s,st = indat[itt+2],itt+3','1010':'f,st = indat[itt+1],itt+3','1000':'st = itt+3','110':'f,s = indat[itt+1],indat[itt+2]','100':'s = indat[itt+2]','10':'f = indat[itt+1]'}
...
while indat[itt] != 99:
    if indat[itt] == 3:
        ...
        # f is first, s is second, and st is store
        #debug
        print('your code and params:',indat[itt:itt+4])
        opcdstr = str(indat[itt])
        #debug
        print(n)
        try:
            f = indat[indat[itt+1]]
